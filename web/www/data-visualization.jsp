      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">         
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Data Visualization - Infographics</h2>
            <p><span class="margin-bottom-0">Statistics from Research and Development Team </span></p>
            <div class="panel panel-default no-border">
              <div class="panel-heading border-radius-10">
                <h2>Network Performances</h2>
              </div>
              <div class="panel-body">
                <div class="templatemo-flex-row flex-content-row margin-bottom-30">
                  <div class="col-1">
                    <div id="gauge_div" class="templatemo-chart"></div>
                    <h3 class="text-center margin-bottom-5">System Backend Services</h3>
                    <p class="text-center">Load Balance</p>              
                  </div>              
                </div>     
              </div>
            </div>            
              ...
              <div class="panel-body">
                <div class="templatemo-flex-row flex-content-row">
                  <div class="col-1">
                    ...
                    <h3 class="text-center margin-bottom-5">Activity Schedule</h3>
                    <p class="text-center">Daily Chart</p>                
                  </div>              
                </div>
              </div> 
            </div>
          ...
          <footer class="text-right">
            <p>Copyright © 2015 Dashboard | Designed by <a href="http://www.ead.com/" target="_parent">Team EAD</a></p>
          </footer>         
        </div>
      </div>
    </div>
    ...
    <script>
      ...
      function drawTimeline() {
        ...
        timelineDataTable.addRows([
          [ 'Engine Block Line',  'Project 003',    new Date(0,0,0,12,0,0),  new Date(0,0,0,14,0,0) ],
          [ 'Engine Block Line',  'Project 003',    new Date(0,0,0,14,30,0), new Date(0,0,0,16,0,0) ],
          [ 'Engine Block Line',  'Project 004', new Date(0,0,0,16,30,0), new Date(0,0,0,19,0,0) ],
          [ 'Transmission Assembly', 'Project 002',   new Date(0,0,0,12,30,0), new Date(0,0,0,14,0,0) ],
          [ 'Transmission Assembly', 'Project 002',       new Date(0,0,0,14,30,0), new Date(0,0,0,16,0,0) ],
          [ 'Transmission Assembly', 'Project 003',        new Date(0,0,0,16,30,0), new Date(0,0,0,18,0,0) ],
          [ 'ECU Programming',   'Project 004',       new Date(0,0,0,12,30,0), new Date(0,0,0,14,0,0) ],
          [ 'ECU Programming',   'Project 004',             new Date(0,0,0,14,30,0), new Date(0,0,0,16,0,0) ],
          [ 'ECU Programming',   'Project 004',          new Date(0,0,0,16,30,0), new Date(0,0,0,18,30,0) ]]);
