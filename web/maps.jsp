      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Geo Charts - Sales Distribution</h2>
            <p class="margin-bottom-0">Extracted from <a href="http://ead.com" target="_parent">Research and Development Statistics</a>.</p>              
          </div>
