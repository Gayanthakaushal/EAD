      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Liyanage</td>
                    <td>cherani</td>
                    <td>cherryliyanage@gmail.com</td>
                    <td><a href="" class="templatemo-edit-btn">Edit</a></td>
                    <td><a href="" class="templatemo-link">Action</a></td>
                    <td><a href="" class="templatemo-link">Delete</a></td>
                  </tr>
          ...
          <div class="templatemo-flex-row flex-content-row">
            ...
            <div class="col-1">              
              <div class="templatemo-content-widget pink-bg">
                ...
                <p class="margin-bottom-0">An agrement was signed between Nissan Motors and the company about supplying 20000 car engines per year with service warrenties</p>                  
              </div>            
              <div class="templatemo-content-widget blue-bg">
                <i class="fa fa-times"></i>
                <h2 class="text-uppercase margin-bottom-10">News</h2>
                <p class="margin-bottom-0">CEO, Chen hun Cook was appointed as the chairmen of national transport board in China.</p>                
              </div>            
            </div>                       
          </div> <!-- Second row ends -->
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="media margin-bottom-30">
                ...
                <div class="media-body">
                  ...
                  <p>Project Manager is celebrating 20 years of sevice</p>
                </div>        
              </div>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td>Involved Projects</td>
                      <td>232</td>                    
                    </tr> 
                    <tr>
                      <td><div class="circle pink-bg"></div></td>
                      <td>Traning Programs</td>
                      <td>22</td>                    
                    </tr>  
                    <tr>
          ...
          <footer class="text-right">
            <p>Copyright © 2015 Dashboard | Designed by Team EAD</a></p>
          </footer>         
        </div>
      </div>
    </div>
